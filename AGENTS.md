...
## 8. MCP: Context7 & Playwright
- Use the **Context7** MCP to pull the latest official documentation and API references when working with new libraries or concepts beyond your base knowledge.
- Use the **Playwright** MCP to automate browser tasks or search the web ONLY when:
